...
public class PassengerService {
    ...
    public PassengerService(ClientRepository clients, PassengerRepository passengers) {
        this.clients = clients; this.passengers = passengers;
    }
    ...
    public Flux<PassengerResponse> list(UUID userId) { return clientId(userId).flatMapMany(passengers::findAllByClientId); }
